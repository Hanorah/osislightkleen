$(document).on('ready',function() {
	...
	/* Hide preloader first — before optional plugins that may not be loaded */
	...
	if ($.fn.imagesLoaded && $.fn.isotope && container_masonry.length) {
	...
	if ($.fn.imagesLoaded && $.fn.isotope && container_grid.length) {
	...
	(function($) {
		"use strict";
		if ($.fn.prettyPhoto && $("a[rel^='prettyPhoto'], a[data-rel^='prettyPhoto']").length != 0) {
...
/* Fallback: always hide preloader once page finishes loading */
